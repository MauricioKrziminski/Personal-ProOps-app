...
| **Notas** | Captura rápida, pastas e lista; detalhe abre por rota. | No iPad e no Android tablet, biblioteca em grade de largura adaptável e nota pela rota existente: um painel de prévia sem edição ocupava a maior parte da tela vazia e foi rejeitado na revisão visual. Busca e captura rápida continuam no topo; editor não vira campo de largura ilimitada. |
